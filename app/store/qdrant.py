...
def search_collection(
    ...
    search_filters: dict[str, list[dict[str, dict[str, Any]]]] | None = None
) -> list[dict[str, Any]]:
    """
    ...
    conflicting_keys = set(
        search_kwargs.keys()) & {'query_vector', 'limit', 'collection_name'}
    if conflicting_keys:
        raise QDRANTArgumentsError(
            f"Conflicting keys found in search_kwargs: {', '.join(conflicting_keys)}"
        )
